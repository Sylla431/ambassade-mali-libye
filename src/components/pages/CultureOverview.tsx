...
import { Star, MapPin, Users, Calendar, ArrowRight, BookOpen, Music, Camera } from 'lucide-react'
    ...
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container-custom">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white text-center mb-12 mt-12">
            Explorez le Mali
          </h2>
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              <div className="h-48 relative overflow-hidden">
                <Image
                  src="/images/culture_tourisme/djenne.jpg"
                  alt="Patrimoine Malien"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Découvrez les trésors du patrimoine malien classés au patrimoine mondial de l'UNESCO.
                </p>
                <div className="space-y-2 mb-4">
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
                    <span>Mosquée de Djenné</span>
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
                    <span>Tombeau des Askia</span>
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
                    <span>Falaises de Bandiagara</span>
                  </div>
                </div>
                <Link 
                  href="/culture/patrimoine"
            ...
            >
              <div className="h-48 relative overflow-hidden">
                <Image
                  src="/images/culture_tourisme/paix.jpeg"
                  alt="Festivals du Mali"
                  fill
                  className="object-cover hover:scale-105 transition-transform duration-300"
                  sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                />
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Célébrez la richesse culturelle et musicale du Mali à travers ses festivals.
                </p>
                <div className="space-y-2 mb-4">
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
                    <span>Festival au Désert</span>
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
                    <span>Festival sur le Niger</span>
                  </div>
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
            ...
            >
              <div className="h-48 relative overflow-hidden">
                <Image
                  src="/images/culture_tourisme/tower.jpg"
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Parcourez les merveilles du Mali, de l'histoire aux paysages naturels.
                </p>
                <div className="space-y-2 mb-4">
                  <div className="text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
                    <div className="w-1.5 h-1.5 bg-primary-600 rounded-full"></div>
