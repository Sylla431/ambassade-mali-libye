...
import { FileText, Calendar, User, ArrowRight, Tag, Search, Loader2, AlertCircle, Filter } from 'lucide-react'
...
export default function ArticlesListIntegrated() {
  ...
  const { articles, loading, loadingMore, error, pagination, loadMore, refresh } = useArticles({
    limit: 6,
  ...
  const { categories: dynamicCategories } = useCategories(categoryOptions)

  // Créer la liste des catégories avec compteurs
  const categories = [
    { name: 'Toutes les catégories', count: articles.length, id: 'all', color: undefined },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Découvrez les dernières nouvelles de l'Ambassade du Mali en Libye et les développements de nos relations bilatérales.
          </p>
        </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {categories.map((category) => (
                <button
                  ...
                  style={category.color && selectedCategory !== category.id ? { borderColor: category.color } : {}}
                >
